...
// --- KONFIGURACJA METADATA (SEO) ---

// Helper do usuwania HTML z opisów
function stripHtml(html: string) {
    return html.replace(/<[^>]*>?/gm, '');
}

// Typ propsów zgodny z Next.js 15
interface PageProps {
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    // Tworzymy czysty opis bez znaczników HTML, przycinamy do 160 znaków
    ...
    return {
        ...
        openGraph: {
            ...
            url: `https://gdyniapadelclub.pl/oferta/${offer.slug}`,
            images: [
                {
                    url: offer.image,
                    width: 1200,
...
export default async function OfferPage({ params }: PageProps) {
    ...
    // Pobieranie danych dynamicznych
    ...
    return (
        <main className="min-h-screen bg-white pb-24">
            ...
            {/* SEKCJA: TRENERZY (jeśli są przypisani) */}
            {offer.trainers && (
